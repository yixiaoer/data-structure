...
下面是对线性表的数组操作
==========================================================*/
Status InitList_Sq(SqList *L) //构造一个空的线性表,书本算法2.3
{
...
Status ListInsert_Sq(SqList *L, int i, ElemType e) //在顺序线性表L中第i各位置之前插入新的元素e,书本算法2.4
{
...
Status ListDelete_Sq(SqList *L, int i, ElemType *e) //在顺序线性表L中删除第i个元素,并用e返回其值,书本算法2.5
{
